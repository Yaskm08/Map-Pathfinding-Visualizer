...
=======
            <a href="https://github.com/Yaskm08/Map-Pathfinding-Visualizer" aria-label="GitHub repository" target="_blank" className={`github-corner ${cinematic ? "cinematic" : ""}`}>
>>>>>>> 9032a2bd (Change github url)
